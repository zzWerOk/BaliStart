...
export default class ToursTypeStore {
    ...
    saveCategoriesList(data) {
        ...
        localStorage.setItem('toursTypePage_listItems', textForSave)
    }

    getSavedCategoriesList() {
        this._itemsArr = localStorage.getItem("toursTypePage_listItems") || '[]'
        this._newItemsArr = ''
    ...
    getSavedLastDateTableToursCategory() {
        if (this._lastDateTableToursCategory === -1) {
            this._lastDateTableToursCategory = localStorage.getItem("lastDateTableToursType") || -1
        }
    ...
    saveLastDateTableToursCategory(newDate) {
        ...
        localStorage.setItem('lastDateTableToursType', newDate)
    }
